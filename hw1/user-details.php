...
if(isset($_GET['id'])) {
    ...
    $query = "SELECT * FROM users WHERE id = $user_id"; // Adjust this query according to your database schema
...
<body>
    ...
    <div id="user-details-container">
        ...
        <?php
        if(isset($user)) {
            echo "<p>Customer: {$user['forename']} {$user['surname']}</p>";
            echo "<p>Username: {$user['username']}</p>";
            echo "<p>Username: {$user['password']}</p>";
         ...
         //for project but not for this homework 
        }
        ?>
